namespace EventHubPublisher
{
	...
	{
		private const string EventHubConnectionString = "Endpoint=sb://matyskuveventhubik.servicebus.windows.net/;SharedAccessKeyName=Root;SharedAccessKey=rNsxmTwOtZjoNQEWAnVWg7SBdzZ/nok+/PzGyF1t8oM=;EntityPath=mujnovyeventhubik"; // ie Endpoint=sb://XXX.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=XXX
		private const string EventHubName = "mujnovyeventhubik"; // ie myeventhub1
